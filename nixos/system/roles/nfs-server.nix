  ...
  services.nfs = {
    ...
    server = {
      ...
      exports = ''
        ...
        /export/backup 172.16.73.0/24(rw,insecure,no_subtree_check) 192.168.68.0/24(rw,insecure,no_subtree_check)
        /export/home *(rw,insecure,no_subtree_check,sec=krb5i)
      '';
    };
  };
}
